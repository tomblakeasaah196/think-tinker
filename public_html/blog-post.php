...
<section class="section" style="padding-top:40px;"><div class="container" style="max-width:760px;">
    ...
    <div style="display:flex;align-items:center;gap:10px;margin-bottom:24px;font-size:.8125rem;color:#999;">
    ...
    <div style="margin-top:40px;padding-top:24px;border-top:1px solid var(--cloud-gray);text-align:center;">
        <p style="color:#999;font-size:.875rem;margin-bottom:12px;">Enjoyed this article? Share it with other parents!</p>
