...
<head>
    ...
    <style>body{background:linear-gradient(135deg,var(--spark-orange),#e06810);min-height:100vh;padding:20px;display:flex;align-items:center;justify-content:center;}.register-card{background:#FFF;border-radius:var(--radius-lg);padding:32px;width:100%;max-width:480px;box-shadow:0 20px 60px rgba(0,0,0,0.2);}</style>
</head>
<body>
<div class="register-card fade-in">
    <div style="text-align:center;margin-bottom:24px;">
        <img src="<?= APP_URL ?>/assets/img/logo/logo-full.png" alt="Think & Tinker Logo" style="height:32px;margin-bottom:16px;">
        <h2 style="color:var(--deep-navy);margin-bottom:8px;">Join STEM Club</h2>
        <p style="color:#666;font-size:0.875rem;margin-bottom:12px;">Robotics, Coding & Hands-on Science for kids. Saturdays only.</p>
        <a href="<?= APP_URL ?>/services/stem-club.php" style="color:var(--tinker-teal);font-size:0.875rem;font-weight:600;text-decoration:underline;">Learn more about our STEM Club</a>
    </div>
    <form id="clubRegForm">
        ...
        <h4 class="mt-3 mb-2" style="color:var(--deep-navy);">Choose a Plan</h4>
