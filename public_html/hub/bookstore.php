...
<div class="page-header"><h1>Bookstore Management</h1><div class="actions"><button class="btn btn-primary btn-sm" onclick="TT.modal.open('#productModal')">+ Add Product</button></div></div>
...
<div class="modal-header"><h3 id="prodModalTitle">Add Product</h3><span class="modal-close">&times;</span></div>
<div class="modal-body"><form id="productForm" enctype="multipart/form-data"><input type="hidden" name="action" value="add_product"><input type="hidden" name="id" value="">
    ...
    <div class="form-row"><div class="form-group"><label class="form-label">Category</label><select name="category" class="form-select"><option value="workbook">Workbook</option><option value="textbook">Textbook</option><option value="stationery">Stationery</option><option value="stem_kit">STEM Kit</option><option value="flashcard">Flashcard</option></select></div><div class="form-group"><label class="form-label">Grade Level</label><input type="text" name="grade_level" class="form-input" placeholder="e.g. Nursery, Primary 1-3"></div></div>
