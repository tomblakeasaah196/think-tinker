<?php $pageTitle='For Schools'; require_once __DIR__.'/../includes/config.php'; require_once __DIR__.'/../includes/icons.php'; include __DIR__.'/../templates/header.php'; ?>
...
<section class="section"><div class="container" style="text-align:center;">
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:20px;">
        <div class="pillar-card reveal" style="--accent:var(--tinker-teal);"><div class="pillar-icon"><?= ttIcon('flask', 'tt-icon', 40) ?></div><h3>STEM Workshops</h3><p>Half-day or full-day workshops for students — science experiments, coding, robotics, and engineering challenges.</p></div>
        <div class="pillar-card reveal" style="--accent:var(--spark-orange);"><div class="pillar-icon"><?= ttIcon('book', 'tt-icon', 40) ?></div><h3>After-School Programs</h3><p>Structured weekly programs that complement your curriculum with enrichment activities and homework support.</p></div>
        <div class="pillar-card reveal" style="--accent:var(--deep-navy);"><div class="pillar-icon"><?= ttIcon('award', 'tt-icon', 40) ?></div><h3>Teacher Training</h3><p>Professional development sessions for your teaching staff on modern pedagogy, STEM integration, and classroom management.</p></div>
    </div>
</div></section>
