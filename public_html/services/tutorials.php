...
<section class="page-hero page-hero--teal" style="padding:56px 0;">
    <div class="container"><div style="font-size:3rem;margin-bottom:12px;">🏠</div><h1 style="font-size:1.875rem;">Home Tutorials</h1></div>
</section>
<section class="section"><div class="container" style="max-width:860px;">
    <img src="<?= APP_URL ?>/assets/img/hero/tutoring-blocks.jpg" alt="Tutor guiding a child through a hands-on home tutorial session" style="width:100%;border-radius:var(--radius-lg);margin-bottom:32px;box-shadow:var(--shadow-md);">
