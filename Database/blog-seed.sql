...
--  Author = user id 1 (Janeth Joseph).
-- ============================================================
...
<p>This is the most common one, and the most commonly missed. A child who cannot do question one has no way to reach question ten, so avoiding the page entirely feels better than failing at it in front of you. Watch for a child who becomes vague — "I\'ll do it later," "the teacher didn\'t explain" — rather than openly defiant.</p>
...
<p><strong>What helps:</strong> a hard thirty minutes of nothing before books — food, rest, no screens. Counter-intuitive, but families who protect that half hour consistently report shorter homework sessions overall, not longer.</p>
...
<p><strong>Short blocks with real breaks.</strong> Twenty-five minutes of work and five minutes off beats a shapeless ninety-minute slog every time. Younger children need shorter blocks still — for a six-year-old, fifteen and five is about right.</p>
...
High turnover is the single most reliable warning sign in Nigerian private education. Facilities can be financed; a settled, experienced staff cannot be bought quickly. If most teachers arrived within the last year, ask why — gently, but ask.</p>
...
Not the distance — the time, on the worst realistic morning. A daily ninety-minute crawl each way will shape your child\'s education more than almost any feature on the tour, and it compounds over years.</p>
...
<p>Ten minutes of that will tell you more than the entire prospectus. Fit matters more than prestige — the best school in Lagos is not the best school for every child in Lagos, and a confident child in a good-enough school will almost always outperform an anxious child in a famous one.</p>', '/assets/img/hero/founder-portrait.jpg', 'educational_insights', '["school selection", "admissions", "Lagos", "consulting"]', 1, 'published', '2026-06-28 09:00:00'),
...
<p>Ask <strong>"what do you think will happen, and why?"</strong> — <em>before</em> you begin. Then let them be wrong.</p>
...
<p><strong>1. Sink or float.</strong> A bowl of water and ten objects. Predict each one first. The surprises — a heavy candle floating, a small coin sinking — are the point.</p>
...
<p><strong>3. Walking water.</strong> Two glasses, one with coloured water, joined by a folded paper towel. Water climbs the towel and travels across. Capillary action — the same way plants drink.</p>

<p><strong>4. Salt on ice.</strong> Two ice cubes, salt on one. It melts faster. Ask why roads in cold countries are salted.</p>

<h2>Ages 8–11</h2>

<p><strong>5. Baking soda volcano — done properly.</strong> Everyone knows it. Make it science by varying <em>one</em> thing: measure the vinegar carefully and see whether double the vinegar gives double the eruption. It does not, and working out why is the lesson.</p>
...
<p><strong>11. Build a water filter.</strong> A cut bottle layered with cotton, sand, gravel and charcoal. Pour muddy water through. Discuss why the output is clearer but still not safe to drink — an important distinction, and a good introduction to public health engineering.</p>
...
<p>Which makes it worth understanding how the habit is actually formed — because the two most common approaches, rewards and requirements, tend to produce children who can read but choose not to.</p>

<h2>Ages 1–3: the sound of it</h2>
...
<h2>Ages 4–6: the mechanics — and the trap</h2>
...
<p>By now the competition is real — homework, lessons, screens, friends. Reading survives only if it has protected space.</p>
...
<p><strong>Interactive.</strong> The child makes decisions the screen responds to. Most games, quiz apps, puzzles. Genuinely mixed — a well-designed strategy game asks real things of a child; a slot-machine-shaped mobile game does not.</p>
...
<p>Rather than a total budget, try a ratio. In our experience the families with the least conflict about screens use something close to <strong>one part passive to two parts interactive or creative</strong> — and they enforce it by making the good options easy rather than by policing the bad ones.</p>
...
<p><strong>2. No screens during meals — including yours.</strong> This one only works if it applies to the whole household, which is exactly why it is effective.</p>
